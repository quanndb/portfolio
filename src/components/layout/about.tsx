...
const Grid = dynamic(() => import("../ui/grid-pattern"), {
  ssr: false,
});
      ...
      <div className="relative bg-gradient-to-b dark:from-teal-950 from-neutral-100 dark:to-neutral-950 to-white p-10 mt-14 rounded-3xl overflow-hidden shadow-xl">
        ...
        <div className="flex flex-col lg:flex-row gap-5 lg:gap-20">
          <div className="flex flex-col gap-5 items-center float-left ">
            <Image
              src={aboutData.author.avatar}
              alt="A picture of me"
              width={300}
              height={300}
              className="rounded-full w-[200px] h-[200px] md:w-[300px] md:h-[300px] object-cover border-4 border-slate-300 dark:border-slate-700"
            />
            ...
            <div className="flex gap-5 flex-wrap justify-center">
              {aboutData.author.socials.map((social) => (
          ...
          <div className="flex-1">
            {aboutData.author.description.map((desc) => (
              <p
                key={desc}
